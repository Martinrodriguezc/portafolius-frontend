...
export function useTeacherSettings() {
  ...
  const [evaluationSettings, setEvaluationSettings] = useState<EvaluationSettingsType>({
  ...
  const handleEvaluationSettingsChange = <K extends keyof EvaluationSettingsType>(
    key: K,
