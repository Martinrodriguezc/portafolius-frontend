      ...
      <div className="p-8 md:p-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center min-h-[400px] bg-white rounded-[16px] shadow-sm border border-slate-100 p-10">
          <div className="relative">
            ...
            <div className="relative inline-block w-16 h-16 border-4 border-[#4E81BD]/20 border-t-[#4E81BD] rounded-full animate-spin mb-6" />
          </div>
          <p className="text-[18px] font-medium text-[#333333] mb-2">
            Cargando tus estudios
          </p>
          <p className="text-[#666666] text-center max-w-md">
            Estamos recuperando la información de tus estudios. Esto tomará solo
            un momento.
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row items-start gap-4">
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-[20px] font-semibold text-red-700 mb-3">
                No se pudieron cargar tus estudios
              </h2>
              <p className="text-[15px] text-red-600 mb-4 max-w-3xl">
                {error.toString() ||
                  "Ha ocurrido un error al obtener los datos de tus estudios."}
              </p>
      ...
      <div className="p-8 md:p-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center min-h-[400px] bg-white rounded-[16px] shadow-sm border border-slate-100 p-10 text-center">
          ...
          <p className="text-[16px] text-[#666666] mb-8 max-w-md">
            Crea o sube un estudio para que aparezca en esta lista y comienza a
            recibir retroalimentación de tus profesores.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-blue-100">
              ...
              <p className="text-[14px] text-[#666666] mb-4">
                Comienza creando un nuevo estudio para organizar tus videos de
                ultrasonido por protocolo.
              </p>
              <Link
                to="/student/create_study"
                className="text-[#4E81BD] text-[14px] font-medium flex items-center"
              >
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-blue-100">
              ...
              <p className="text-[14px] text-[#666666] mb-4">
                Sube videos de ultrasonido (3-5 segundos) para cada protocolo
                que quieras evaluar.
              </p>
              <Link
                to="/student/upload"
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-blue-100">
              ...
              <p className="text-[14px] text-[#666666] mb-4">
                Tus profesores evaluarán tus videos y te proporcionarán
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="grid grid-cols-3 gap-4 w-full md:w-auto">
            ...
            <div className="bg-white p-3 rounded-lg shadow-sm border border-[#4E81BD]/20 text-center">
              ...
              <p className="text-sm font-medium text-[#333333]">
                {studies.some(
                  (s) => s.status === "EVALUADO" && s.score !== null
                )
                  ? (
                      studies
                        .filter(
                          (s) =>
                            s.status === "EVALUADO" && s.score !== null
                        )
          ...
          >
            ...
            <div className="p-6 space-y-4 text-center sm:text-left">
              ...
              {study.status === "EVALUADO" && study.score !== null && (
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                    ...
                    <span className="text-sm font-bold text-[#4E81BD]">
                      {study.score}/10
                    </span>
                  </div>
              ...
              <div className="flex justify-center">
                <Link to={`/student/studies/${study.id}/videos`} className="w-full sm:w-auto">
                  <Button className="w-full sm:w-auto bg-[#4E81BD] hover:bg-[#4E81BD]/90 text-white font-medium py-2.5 px-6 rounded-[8px] transition-colors">
                    Ver videos
                  </Button>
                </Link>
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 border-b border-blue-100">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[16px] font-semibold text-[#333333]">
                  Consejos para mejorar tus estudios
                </h3>
              </div>
            </div>
            <div className="p-5">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-[#666666]">
                    <span className="font-medium text-[#333333]">
                      Mantén el transductor estable
                    </span>{" "}
                    durante la adquisición de imágenes para obtener videos de
                    mejor calidad.
                  </p>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-[#666666]">
                    <span className="font-medium text-[#333333]">
                      Ajusta la profundidad y ganancia
                    </span>{" "}
                    adecuadamente para visualizar correctamente las estructuras
                    anatómicas.
                  </p>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-[#666666]">
                    <span className="font-medium text-[#333333]">
                      Etiqueta correctamente tus videos
                    </span>{" "}
                    con el protocolo y las estructuras anatómicas
                    correspondientes.
                  </p>
                </li>
              </ul>
              <div className="mt-4 pt-4 border-t border-slate-100">
                ...
                >
                  Ver más recursos de aprendizaje{" "}
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#666666]">
                      Organiza tus videos por protocolos específicos para un
                      mejor seguimiento.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#666666]">
                      Mantén un registro constante de tu progreso subiendo
                      videos periódicamente.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#666666]">
                      Analiza los comentarios de tus profesores para mejorar tus
                      técnicas.
                    </p>
                  </div>
                </div>
