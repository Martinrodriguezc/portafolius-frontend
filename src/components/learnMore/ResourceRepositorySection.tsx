          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-slate-50 p-5 rounded-lg border border-slate-100">
              ...
              <p className="text-sm text-slate-600">
                Acceda a videos demostrativos de técnicas y procedimientos
            ...
            <div className="bg-slate-50 p-5 rounded-lg border border-slate-100">
              ...
              <p className="text-sm text-slate-600">
                Biblioteca de papers y publicaciones relevantes en el campo del
                Ultrasonido Clínico.
              </p>
            </div>
            <div className="bg-slate-50 p-5 rounded-lg border border-slate-100">
              ...
              <p className="text-sm text-slate-600">
                Estudie casos reales con diferentes hallazgos y aprenda a
            ...
            <div className="bg-slate-50 p-5 rounded-lg border border-slate-100">
              ...
              <p className="text-sm text-slate-600">
                Documentación detallada sobre los diferentes protocolos de
                Ultrasonido Clínico.
              </p>
            </div>
          </div>
