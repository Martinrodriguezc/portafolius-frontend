        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600 mb-4">
              Suba y organice estudios de ultrasonido (videos de 3-5 segundos)
              por protocolo, manteniendo un orden cronológico para visualizar su
              progreso.
            </p>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600 mb-4">
              Los profesores pueden interactuar directamente con los videos,
              añadiendo anotaciones, destacando áreas importantes y
              proporcionando retroalimentación específica.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#4E81BD] mr-2 shrink-0 mt-0.5" />
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600 mb-4">
              Visualice su curva de aprendizaje para cada protocolo,
              permitiéndole identificar áreas de mejora y celebrar sus avances.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#4E81BD] mr-2 shrink-0 mt-0.5" />
              ...
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#4E81BD] mr-2 shrink-0 mt-0.5" />
                <span className="text-sm text-slate-600">
                  Estadísticas detalladas sobre su desempeño a lo largo del
                  tiempo
                </span>
              </li>
            </ul>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600 mb-4">
              Facilite la comunicación entre estudiantes y profesores a través
              de mensajería integrada y comentarios en los estudios.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#4E81BD] mr-2 shrink-0 mt-0.5" />
