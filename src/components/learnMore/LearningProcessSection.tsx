  ...
  return (
    <section className="py-16 bg-slate-50">
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="max-w-lg sm:max-w-2xl md:max-w-4xl mx-auto">
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-[#4E81BD]/30" />

            <div className="relative flex flex-col md:flex-row items-center mb-12">
              <div className="flex-1 text-center md:text-right md:pr-8 mb-4 md:mb-0">
              ...
              <div className="flex-1 hidden md:block md:pl-8" />
            </div>

            <div className="relative flex flex-col md:flex-row items-center mb-12">
              <div className="flex-1 hidden md:block md:text-right md:pr-8" />
              <div className="z-10 w-8 h-8 rounded-full bg-[#4E81BD] flex items-center justify-center text-white font-bold">
                2
              </div>
              <div className="flex-1 text-center md:pl-8 mb-4 md:mb-0">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  Adquisición de conocimiento práctico
                </h3>
                <p className="text-slate-600">
