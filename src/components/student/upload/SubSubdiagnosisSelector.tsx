...
import { SubSubdiagnosisSelectorProps } from "../../../types/Props/Upload/SubSubdiagnosisSelectorProps";

export const SubSubdiagnosisSelector: React.FC<SubSubdiagnosisSelectorProps> = ({
  options,
  value,
  onChange,
}) => (
