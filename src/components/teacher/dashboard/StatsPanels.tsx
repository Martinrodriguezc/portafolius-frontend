// components/teacher/StatsPanel.tsx
...
const StatCard: React.FC<{
  ...
  <Card className={`bg-gradient-to-br from-${from} to-${to} p-6 rounded-[16px] shadow-sm border ${border}`}>
...
export const StatsPanel: React.FC<StatsPanelProps> = ({
  pendingCount, evaluatedToday, studentCount,
}) => (
